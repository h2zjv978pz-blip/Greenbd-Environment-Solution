export const metadata = { title: 'Photo Gallery', description: 'Visual documentation of environmental projects, field surveys and community programmes across Bangladesh.', alternates: { canonical: '/resources/gallery' } };
